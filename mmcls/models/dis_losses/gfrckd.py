...
class GFRCKDLoss(nn.Module):
    def __init__(self,
        ...
        super(GFRCKDLoss, self).__init__()
        self.alpha_gfrckd = alpha_gfrckd
        self.lambda_gfrckd = lambda_gfrckd
    ...
    def forward(self,
        ...
        # Mask tokens
        B, N, D = x.shape
        x, mat, ids, ids_masked = self.random_masking(x, self.lambda_gfrckd)
        ...
        loss_gen = loss_gen / B * self.alpha_gfrckd / self.lambda_gfrckd
