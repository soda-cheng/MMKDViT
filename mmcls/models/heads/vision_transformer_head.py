...
class VisionTransformerClsHead(BaseHead):
    """Classification head.
    ...
    def __init__(self,
                 ...
                 cal_acc: bool = False,
                 **kwargs):
        super(VisionTransformerClsHead, self).__init__(init_cfg=init_cfg, **kwargs)
    ...
    def classtoken(self, feats: Tuple[torch.Tensor]):
        cls_score = self(feats)
        class_token_t = F.softmax(cls_score, dim=1)
        return class_token_t
